...
namespace Graphics
{
	...
	{
		m_ViewProjection = m_ProjectionMatrix * Core::FastInverse(m_ViewMatrix);
	}
	...
	void Camera::SetTranslation(const Core::Vector4f& translation)
	{
		m_ViewMatrix.SetTranslation(translation);
	}
